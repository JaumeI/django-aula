...
urlpatterns = patterns('',
    ...
    url(r'^telefons', 'aula.apps.extSMS.views.triaGrupsTelefons', name = 'consergeria__missatges__telefons'),
    url(r'^genera-telefons/(?P<grup>\d+)/$', 'aula.apps.extSMS.views.generaTelefons', name = 'consergeria__missatges__gentelefons'),
